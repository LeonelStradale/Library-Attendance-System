<x-guest-layout>
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5">
                                ...
                                <!-- MODAL: Form -->
                                <form class="space-y-4 mt-8" action="{{ route('storeExit') }}" method="POST">
                                    @csrf
    ...
    <!-- ABOUT MODAL: Button -->
    <button data-modal-target="about-modal" data-modal-toggle="about-modal" type="button"
        class="fixed bottom-4 right-14 inline-flex items-center justify-center p-0.5 mb-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
        <span
