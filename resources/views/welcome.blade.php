                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5">
                                ...
                                <form class="space-y-4 mt-8" action="#">
                                    ...
                                    <!-- MODAL: Submit -->
                                    <a href="{{ route('entrance') }}"
                                        class="block text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                                        {{ __('Find user') }}
                                    ...
                                    <a href="{{ route('createExternalPeople') }}"
